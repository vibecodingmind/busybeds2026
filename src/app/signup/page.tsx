    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0E5C3B]/5 via-white to-white dark:from-[#0E5C3B]/10 dark:via-[#0F1117] dark:to-[#0F1117]">
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="text-center mb-6">
          <Link href="/">
            <img src="/logo.svg" alt="BusyBeds" className="h-10 w-auto mx-auto" />
          </Link>
        </div>
        ...
        {mode === 'choose' && (
          <div className="text-center">
            ...
            <div className="grid grid-cols-3 gap-3 mb-8">
              {[
                { icon: TrendingUp, label: 'Boost Revenue', color: 'text-[#0E5C3B] dark:text-[#10b981]' },
                { icon: Shield, label: 'Trusted Platform', color: 'text-[#0E5C3B] dark:text-[#10b981]' },
                { icon: Globe, label: 'Reach Africa', color: 'text-[#0E5C3B] dark:text-[#10b981]' },
              ].map(b => (
                <div key={b.label} className="p-3 rounded-xl bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50">
                  <b.icon className={`h-5 w-5 ${b.color} mx-auto mb-1.5`} />
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">List your hotel, offer discount coupons, manage bookings & analytics</p>
                  </div>
        ...
        {mode === 'register' && (
          <div>
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs"><span className="bg-white dark:bg-[#0F1117] px-3 text-gray-400">or sign up with email</span></div>
            </div>
        ...
        {mode === 'login' && (
          <div>
            ...
            <div className="relative my-5">
              <div className="absolute inset-0 flex items-center"><span className="w-full border-t border-gray-200 dark:border-gray-700" /></div>
              <div className="relative flex justify-center text-xs"><span className="bg-white dark:bg-[#0F1117] px-3 text-gray-400">or log in with email</span></div>
            </div>
